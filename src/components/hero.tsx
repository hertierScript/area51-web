      ...
      <div className="container relative mx-auto px-4 z-10">
        <div className="text-center">
          ...
          >
            ...
            <span className="block text-primary drop-shadow-[0_0_15px_rgba(0,255,0,0.5)]">
              Flavors from Area 51
            </span>
          </motion.h1>
          ...
          >
            Experience the most classified recipes in the galaxy. Delivered
            straight to your bunker in light speed.
          </motion.p>
          ...
          >
            ...
            <Link href="/menu">
              <Button
                variant="outline"
                size="lg"
                className="border-white text-white hover:bg-white/10 text-lg px-8 py-6 rounded-full font-bold"
              >
                View Menu
              </Button>
            </Link>
